...
from backbone.ResNet_Backbone import *
from neck.SPPF import *
from head.yolo_head import *
from utils.nms import multiclass_nms


class FYOLOv1(nn.Module):
    def __init__(self,
                 cfg,
                 device,
                 img_size=None,
        ...
        # neck
        self.neck = build_neck(cfg, feat_dim, cfg['neck_out_dim'])
